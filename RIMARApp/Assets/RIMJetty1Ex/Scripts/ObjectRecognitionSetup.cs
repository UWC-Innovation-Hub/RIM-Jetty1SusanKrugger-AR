...
public class ObjectRecognitionSetup : MonoBehaviour
{
    [Header("Quick Setup")]
...
SIMPLE OBJECT RECOGNITION SETUP:
...
";
    ...
    void Update()
    {
        // Capture mode controls using new Input System
        if (captureMode && Keyboard.current != null && Keyboard.current.spaceKey.wasPressedThisFrame)
        {
            CaptureReferenceImage();
        }
        
        // Quick toggle capture mode
    ...
    void ShowInstructions()
    {
        ...
        {
            Debug.Log("🎯 SIMPLE OBJECT RECOGNITION SETUP");
            Debug.Log("==================================");
